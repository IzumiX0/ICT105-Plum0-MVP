...
Meeting schedule: Every Wednesday after class or as needed.
Communication channel: Discord Group.
File naming rule: lowercase-with-hyphen.
GitHub commit rule: Create meaningful commits after completing each task.
Conflict resolution rule: Discuss as a team first; if no agreement is reached, decide by majority vote.
